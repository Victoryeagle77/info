/* Question 2 : Copie d'un fichier
Faire un programme réalisant la copie d'un fichier.
Les noms des fichiers source et destination seront donnés en argument de commande.
Les erreurs relatives au manque d'arguments et aux appels systèmes doivent être gérées.
*/
...
int main(int argc, char const *argv[]){ 
    ...
    FILE* flux_destination = NULL; // Flux du fichier dans lequel on veut placer le flux du fichier de départ.
    char buffer[256]; 
    int lecture; 
