...
/* Fonction relevant la date actuelle */
...
extern void creer_graph(Display *, const Window, const short int, 
                        const short int, const short int, 
                        const short int, const XContext);
extern void creer_saisie(Display *, const Window, const short int, 
                        const short int, const short int, 
                        const short int, const XContext);
...
extern void config_canvas(Zone *, XEvent *);
