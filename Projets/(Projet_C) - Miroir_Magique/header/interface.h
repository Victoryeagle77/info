...
extern const GC style(Display *d, const char*, const unsigned int);
...
extern void tracer_fonction(Display *, const Window, volatile unsigned short int, 
