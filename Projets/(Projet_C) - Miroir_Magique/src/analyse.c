...
extern volatile unsigned char *date(char *chaine){
    ...
    sprintf(chaine, "%02d/%02d/%d - %02d:%02d", tm.tm_mday, 
...
static void lire_donnee(void){
	...
	/* Verifier que la lecture est de 40 bits, et la somme du dernier octet.
	(car on a 1 octet de 8 bits * 5 cases du tableau de donnees = 40),
