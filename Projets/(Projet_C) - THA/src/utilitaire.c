...
extern const uint_fast8_t decodage(volatile XChar2b *affiche, const uint_fast8_t debordement, 
...
extern void saisie(Display *d, XEvent *e, const uint_fast8_t id){
    static uint8_t buffer[2], temperature[5] = " ", humidite[5] = " ";
    ...
    if(id == 0){
        /* Suppression dans la zone pour la reecriture de la chaine */
