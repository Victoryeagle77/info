...
extern void database(void){
    ...
    /* Allocation dynamique pour l'utilisation des parametres de la structure */
    d = (struct data *)malloc(sizeof(struct data));
    /* Ouverture du flux de donnee en lecture et ecriture */
    d->fd = open(FLUX, O_RDWR | O_CREAT, 0644);
