...
int main(void){
	...
	int taille2 = 1200;
	terrain** relief;
	/* Creation de la fenetre et initialisation des variables */
	...
	/* Allocaton dynamique de la premiere dimension du tableau */
	relief = malloc(taille1 * sizeof(*relief));
	/* Allocation dynamique de la deuxieme dimension du tableau */
	for(i=0; i<taille1; i++){
	...
	while(1){
		...
		/* Affichage de la carte generee et commandes */
