...
extern void menu_saisie(const XEvent *e, Window *zone, volatile unsigned short int y){
   ...
   XDrawString(e->xany.display, container, style(e->xany.display, 0xffffff), 
               25, 140, "Temperature (0 to 50)", 21);
   XDrawString(e->xany.display, container, style(e->xany.display, 0xffffff), 
               25, 220, "Humidity (20 to 80)", 19);

   /* Consignes */
   XDrawString(e->xany.display, container, style(e->xany.display, 0xcc0000), 
               25, y-140, "You can enter maximum of", 24);
   XDrawString(e->xany.display, container, style(e->xany.display, 0xcc0000), 
               25, y-120, "temperature and humidity", 24);
   XDrawString(e->xany.display, container, style(e->xany.display, 0xcc0000), 
               25, y-100, "to don't exceed.", 16);
   XDrawString(e->xany.display, container, style(e->xany.display, 0xcc0000), 
               25, y-80, "Press Enter to confirm.", 23);
}
