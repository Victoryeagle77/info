...
Les gestionnaires de mise en page que nous avons vu ne permettent pas de réaliser une telle configuration, 
même en combinaison. Il est possible dans ce cas de poser les composants «manuellement». 
On désactive d'abord le gestionnaire actuel avec :
