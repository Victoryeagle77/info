/*
Question 3 : Contingence. 
Écrivez une application qui ouvre une fenetre contenant un champ de texte le long du bord inférieur, 
et une zone de texte occupant le reste de l'espace. 
...
Son constructeur réclame trois entiers compris entre 0 et 255 qui donnent respectivement la quantité de rouge, 
de vert et de bleu qui la composent. 
Un objet de cette classe peut ensuite servir d'argument à la méthode setForeground, 
ou à la méthode setBackground qui sont définies aussi bien dans JTextArea que dans JTextField. 
On souhaite que les lignes trop longues se poursuivent automatiquement sur la ligne suivante. 
La classe JTextArea possède une méthode setLineWrap qui prend un booléen en argument,
et qui contrôle ce comportement. 
*/
...
public class Contingence {
  ...
  public static void main(String[] args) {
    ...
    /* Barre de scrolling sur la fenêtre */
