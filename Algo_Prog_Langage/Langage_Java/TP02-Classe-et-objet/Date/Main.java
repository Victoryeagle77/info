...
Pour commencer, définissez une telle classe en prévoyant un constructeur et une méthode toString,
qui renvoie une chaîne décrivant la date au format ISO 8601 (AAAA-MM-JJ). 
