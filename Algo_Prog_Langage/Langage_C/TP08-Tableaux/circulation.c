...
Modifiez le programme du premier exercice pour qu'il avance les valeurs du tableau de 4 indices 
(les valeurs à la fin se retrouveront au début). 
Vous afficherez le tableau avant et après permutation pour vérifier votre travail.
----------
|Remarque| La valeur 4 est arbitraire.  
----------
Faites-en une constante nommée et assurez-vous que le programme marche aussi pour d'autres valeurs de décalage.
*/
