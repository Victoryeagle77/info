...
Le programme affichera alors le plus petit indice où on peut trouver cette valeur dans le tableau (ou -1 si la valeur ne s'y trouve pas). 
*/
...
int main (void){ 
	...
	*/
  	if (i==(TAB))
              ...
              printf("Le plus petit indice pour cet entier est : %d\n", i);
        return 0;
}
