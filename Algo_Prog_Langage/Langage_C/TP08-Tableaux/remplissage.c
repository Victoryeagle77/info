...
Écrivez un programme qui déclare un tableau de 10 cases de type int, 
puis le remplit avec des valeurs choisies aléatoirement entre -50 et 50, et enfin affiche le contenu du tableau. 
