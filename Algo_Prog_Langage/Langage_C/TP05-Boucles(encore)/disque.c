...
Remarque : On se souviendra que les points d'un disque sont les points dont la distance au centre 
...
int main(void){
  ...
  [Par exemple -> pour un rayon de 2, on aura un diamètre de 4 + le centre 
  (soit 5 caractères '*' pour chaque distances)]
  */
