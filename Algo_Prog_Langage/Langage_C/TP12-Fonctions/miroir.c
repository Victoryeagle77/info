...
puis de la dernière à la première valeur dans le sens d'apparition des valeurs du tableau normale,
sans inverser l'ordre.

Définissez une fonction qui affiche le tableau, une fonction qui le remplit de valeurs aléatoires, 
et une fonction qui inverse le tableau. 
