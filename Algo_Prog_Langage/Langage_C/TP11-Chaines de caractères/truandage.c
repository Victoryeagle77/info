...
int main(void){
  long long int n = 32217268732456802LL;
  printf("* Chaine debut : %s\n", &n); /* Cette partie du programme affiche "bonjour". */
  /*
  - En faisant printf("%x", n), on remarque que ce mot correspond en hexadécimal à 6a 6e 6f 62, 
  soit "jnob", converti en ascii.
  - On en déduit qu'il faudrait y rajouter le suffixe "rios", soit 72 69 6f 73 en hexadécimal, 
  et enlever la lettre 'j' soit, en tenant compte de l'odre inversé par la transcription en adresse, 6a.
