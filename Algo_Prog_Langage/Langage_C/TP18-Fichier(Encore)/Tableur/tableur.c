...
Faites 3 tableaux multidimensionnels et sauvegardez les tableaux dans des fichiers nommés t1.csv, t2.csv, 
et t3.csv. Si vous respectez bien le format, vous devriez pouvoir ouvrir ces fichiers à l'aide d'un tableur. 
*/
