...
À l'aide de cette fonction, écrivez un programme qui lit à la console un paragraphe 
(terminé par un saut de ligne) et qui l'affiche ensuite en une colonne de texte justifié large de 50 caractères. 
Exemple de session :

bob@box:~$ ./a.out
Entrez votre texte : Lorem ipsum dolor sit amet, consectetur adipisici elit, 
...
int main (void) {
  /* Constante de chaine dans les entrées / sorties standard et d'au moins 256. */
  char text[BUFSIZ];
