...
Écrivez un programme qui reçoit une liste de réels et affiche uniquement 
les valeurs présentes une seule fois dans la liste.

Le programme ne demandera pas au préalable à l'utilisateur combien de réels il souhaite rentrer, 
il devra taper q pour quitter. Il affichera ensuite, les valeurs qui n'ont pas été répétées. */
