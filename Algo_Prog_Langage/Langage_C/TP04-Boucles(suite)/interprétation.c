...
Écrivez un programme qui demande un entier naturel, puis en affiche le carré. Pour cet exercice, vous ne devez pas utiliser scanf (mais il vous reste getchar).
*/
