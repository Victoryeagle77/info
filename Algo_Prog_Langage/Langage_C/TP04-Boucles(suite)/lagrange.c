...
Un théorème dû à Lagrange affirme que tout entier naturel peut s'écrire comme la somme de quatre carrés. Par exemple :
...
Écrivez un programme qui demande un entier naturel, et affiche toutes ses décompositions sous la forme d'une somme de 4 carrés 
