...
/*
3) - La condition est valable pour (NULL%2) et non pas (NULL), ce qui ne correspond pas au temps de la première exécution du programme.
...
- Donc x est le mort-vivant car il est "mort" pour le pointeur p en tant qu'adresse mais "vivant" en tant que variable.
*/
